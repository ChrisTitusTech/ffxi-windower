...
function get_sets()
    ...
    sets.midcast.BP = {
        ...
        head={name="Caller's Horn +1",hp=31,mp=134},
        body={name="Caller's Doublet +2",hp=54,mp=151},
        ...
        feet={ name="Caller's Pigaches +1",hp=9,mp=97},
        neck="Caller's Pendant",
        waist="Lucidity Sash",
        left_ear={ name="Andoaa Earring", mp=30},
        right_ear="Smn. Earring",
        left_ring={name="Evoker's Ring",mp=25},
    ...
    sets.midcast['Elemental Magic'] = {
        ...
        waist={name="Hachirin-no-Obi",mp=35},
        left_ear="Friomisi Earring",
        right_ear="Crematio Earring",
        left_ring="Shiva Ring +1",
        right_ring="Shiva Ring +1",
        back={ name="Toro Cape", mp=30},
    }
    ...
    sets.midcast.Myrkr = {
        ...
        waist={name="Lucidity Sash",mp=60},
