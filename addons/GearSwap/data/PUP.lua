...
function user_setup()
   ...
   --[[
    ...
    send_command('bind ` input /pet "Deploy" <t>')
    send_command('bind !` input /ja "Repair" <me>')
...
function init_gear_sets()
    ...
    Artifact_Foire.Feet_Repair_PMagic = "Foire Bab. +1"
    ...
    Relic_Pitre.Feet_PMagic = "" --Role Reversal

    Empy_Karagoz = {}
    Empy_Karagoz.Head_PTPBonus = "Cirque Capello +1"
    Empy_Karagoz.Body_Overload = "Cirque Farsetto +2"
    Empy_Karagoz.Hands = ""
    Empy_Karagoz.Legs_Combat = "Cirq. Pantaloni +2"
    Empy_Karagoz.Feet_Tatical = ""
